// ═══════════════════════════════════════════════════════════════════════════════
// BLAZOR DEVELOPER TOOLS - timeline-panel.ts (Firefox)
// ═══════════════════════════════════════════════════════════════════════════════
//
...
function renderSwimlane(componentName: string, visibleStart: number, visibleRange: number): string {
        ...
        <div class="swimlane-row">
            ...
            <div class="swimlane-track">
                ${componentEvents.map(e => {
                    ...
                    if (eventEnd < visibleStart || eventStart > visibleStart + visibleRange) return '';
...
function generateTimeAxis(startTime: number, endTime: number): string {
    const ticks = 5;
